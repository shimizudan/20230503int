...
# ╔═╡ d9b845da-ea50-11ed-3181-09cbb4ed3082
begin
	using Plots
	plotly()
...
# ╔═╡ 93bc63d4-9483-42ed-abb4-017f7b52e405
md"""
# 立方体の外接球
 清水団　Dan Shimizu  ([@dannchu](https://twitter.com/dannchu))

Julia言語で，Geogebraみたいに立体を描いてみました。

- 球を描く
- 立方体を描く
- 表面を半透明にする→alpha=0.5など
- 図形を動かすことができる→plotly()
- webページに埋め込む→pluto.jlを使ってHTMLで書き出す。
"""
